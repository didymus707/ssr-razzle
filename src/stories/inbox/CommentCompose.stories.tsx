...
import { CommentCompose, CommentComposeProps } from 'app/authenticated-app/inbox';

export default {
  title: 'Inbox/CommentCompose',
  component: CommentCompose,
} as Meta;

const Template: Story<CommentComposeProps> = args => <CommentCompose {...args} />;
